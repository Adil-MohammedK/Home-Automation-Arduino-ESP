...
#define AIO_SERVER      "192.168.1.38"
...
Adafruit_MQTT_Publish DHT = Adafruit_MQTT_Publish(&mqtt,"feeds/DHT");
Adafruit_MQTT_Publish PIR = Adafruit_MQTT_Publish(&mqtt,"feeds/PIR");
